...
public class CommonWarriorSkills {
    ...
    public static List<SkillButton> getNodes(ResourceLocation BUTTON_TEXTURE, PlayerClassData data, PlayerSAttrubitesData sAttributesData, int buttonWidth, int buttonHeight) {
        ...
        nodes.add(new SkillButton(
                ...
                BUTTON_TEXTURE,
                Component.translatable("skill.era_tweaks.common_warrior_skill_1"),
                "common_warrior_skill_1",
                ...
                btn -> {
                    ...
                    Network.toServerAction("common_warrior_skill_1", 1);
                }
        ));
        nodes.add(new SkillButton(
                -480, -300, buttonWidth, buttonHeight,
                BUTTON_TEXTURE,
                Component.translatable("skill.era_tweaks.common_warrior_skill_2"),
                "common_warrior_skill_2",
                new SkillCondition(List.of(), true),
                "none",
                () -> List.of(
                        Component.translatable("tooltip.era_tweaks.skill_requirements"),
                ...
                btn -> {
                    ...
                    Network.toServerAction("common_warrior_skill_2", 1);
                }
        ));
        nodes.add(new SkillButton(
                -380, -300, buttonWidth, buttonHeight,
                BUTTON_TEXTURE,
                Component.translatable("skill.era_tweaks.common_warrior_skill_3"),
                "common_warrior_skill_3",
                new SkillCondition(List.of(), true),
                "none",
                () -> List.of(
                        Component.translatable("tooltip.era_tweaks.skill_requirements"),
                ...
                btn -> {
                    ...
                    Network.toServerAction("common_warrior_skill_3", 1);
                }
        ));
        nodes.add(new SkillButton(
                -280, -300, buttonWidth, buttonHeight,
                BUTTON_TEXTURE,
                Component.translatable("skill.era_tweaks.common_warrior_skill_4"),
                "common_warrior_skill_4",
                new SkillCondition(List.of(), true),
                "none",
                () -> List.of(
                        Component.translatable("tooltip.era_tweaks.skill_requirements"),
                ...
                btn -> {
                    ...
                    Network.toServerAction("common_warrior_skill_4", 1);
                }
        ));
        nodes.add(new SkillButton(
                -180, -300, buttonWidth, buttonHeight,
                BUTTON_TEXTURE,
                Component.translatable("skill.era_tweaks.common_warrior_skill_5"),
                "common_warrior_skill_5",
                new SkillCondition(List.of(), true),
                "none",
                () -> List.of(
                        Component.translatable("tooltip.era_tweaks.skill_requirements"),
                ...
                btn -> {
                    ...
                    Network.toServerAction("common_warrior_skill_5", 1);
                }
        ));
        ...
        nodes.add(new SkillButton(
                ...
                BUTTON_TEXTURE,
                Component.translatable("skill.era_tweaks.common_warrior_skill_6"),
                "common_warrior_skill_6",
                new SkillCondition(List.of(), true),
                "none",
                () -> List.of(
                        Component.translatable("tooltip.era_tweaks.skill_requirements"),
                ...
                btn -> {
                    ...
                    Network.toServerAction("common_warrior_skill_6", 1);
                }
        ));
        ...
        nodes.add(new SkillButton(
                ...
                BUTTON_TEXTURE,
                Component.translatable("skill.era_tweaks.common_warrior_skill_7"),
                "common_warrior_skill_7",
                new SkillCondition(List.of(), true),
                "none",
                () -> List.of(
                        Component.translatable("tooltip.era_tweaks.skill_requirements"),
                ...
                btn -> {
                    ...
                    if (data.getPlayerSkills().size() < 3) {return;}
                    Network.toServerAction("common_warrior_skill_7", 1);
                }
        ));
        ...
        nodes.add(new SkillButton(
                ...
                BUTTON_TEXTURE,
                Component.translatable("skill.era_tweaks.common_warrior_skill_8"),
                "common_warrior_skill_8",
                new SkillCondition(List.of(), true),
                "none",
                () -> List.of(
                        Component.translatable("tooltip.era_tweaks.skill_requirements"),
                ...
                btn -> {
                    ...
                    if (data.getPlayerSkills().size() < 3) {return;}
                    Network.toServerAction("common_warrior_skill_8", 1);
                }
        ));
        ...
        nodes.add(new SkillButton(
                ...
                BUTTON_TEXTURE,
                Component.translatable("skill.era_tweaks.common_warrior_skill_9"),
                "common_warrior_skill_9",
                new SkillCondition(List.of(), true),
                "none",
                () -> List.of(
                        Component.translatable("tooltip.era_tweaks.skill_requirements"),
                ...
                btn -> {
                    ...
                    if (data.getPlayerSkills().size() < 3) {return;}
                    Network.toServerAction("common_warrior_skill_9", 1);
                }
        ));
        ...
        nodes.add(new SkillButton(
                ...
                BUTTON_TEXTURE,
                Component.translatable("skill.era_tweaks.common_warrior_skill_10"),
                "common_warrior_skill_10",
                new SkillCondition(List.of(), true),
                "none",
                () -> List.of(
                        Component.translatable("tooltip.era_tweaks.skill_requirements"),
                ...
                btn -> {
                    ...
                    if (data.getPlayerSkills().size() < 3) {return;}
                    Network.toServerAction("common_warrior_skill_10", 1);
                }
        ));
        return nodes;
    }
